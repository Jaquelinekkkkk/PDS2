...
//  }
//    if(dao.bancoOnline()){
//        lblBD.setText("Banco de dados: online");
//        lblBD.setStyle("-fx-text-fill: blue:");
//    }else{
//    lblBD.setText("Banco de dados: offline");
//    lblBD.setStyle("-fx-text-fill: red:");
        ...
        if (!dao.bancoOnline()) {
            ...
            if (listaDados != null) {
             //   System.out.println("Bem vindo "
                 ...
                 AlertaUtil.mostrarInformacao("Informacao", "Bem vindo"
                  + listaDados.get(0) + " acesso liberado!");
            ...
            AlertaUtil.mostrarErro("Erro", "Usuario e senha invalidos! ");

            }
        } else {
          //  System.out.println("Verifique as informações!");
          AlertaUtil.mostrarErro("Erro", "Verifique as informacoes! ");
        }
